"""
    DQN algorithm on CO2 cost optimization

    To run only CO2 cost optimization, You have to install pymgrid tool from below repository
    https://github.com/anushaihalapathirana/pymgrid

    git clone https://github.com/anushaihalapathirana/pymgrid
    cd pymgrid
    pip install .
    then run this code to optimize co2 cost alone.
"""
import sys
...
nb_epoch = 25 # length of the training process
results = []
episode_data = []
episode_json = []
checkpoint_path=''
